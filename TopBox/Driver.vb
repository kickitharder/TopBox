...
'
' ASCOM Focuser driver for TopBox
'
...
'
'
' Your driver's ID is ASCOM.TopBox.Focuser
'
...
Public Class Focuser
    ...
    ' The Guid attribute sets the CLSID for ASCOM.TopBox.Focuser
    ' The ClassInterface/None attribute prevents an empty interface called
    ' _TopBox from being created and used as the [default] interface
    ...
    '
    Friend Shared driverID As String = "ASCOM.TopBox.Focuser"
    Private Shared driverDescription As String = "TopBox Focuser"

    Friend Shared comPortProfileName As String = "COM Port" 'Constants used for Profile persistence
    Friend Shared traceStateProfileName As String = "Trace Level"
    Friend Shared absoluteModeProfileName As String = "Focuser Mode"
    Friend Shared backlashInfoProfileName As String = "Backlash Info"
    Friend Shared comPortDefault As String = "COM12"
    Friend Shared traceStateDefault As String = "False"
    Friend Shared absoluteModeDefault As String = "False"
    Friend Shared backlashInfoDefault As String = "0"
...
#Region "Common properties and methods"
    ...
    Public ReadOnly Property DriverInfo As String Implements IFocuserV3.DriverInfo
        Get
            ...
            Dim s_driverInfo As String = "Version 0.210214   " + m_version.Major.ToString() + "." + m_version.Minor.ToString()
    ...
    Public ReadOnly Property Name As String Implements IFocuserV3.Name
        Get
            Dim s_name As String = "TopBox Focuser"
...
#Region "IFocuser Implementation"
    ...
    Public ReadOnly Property IsMoving() As Boolean Implements IFocuserV3.IsMoving
        Get
            ...
            Dim movingStr As String = SerialCmd("I")
            If movingStr = "Error" Then Throw New NotConnectedException("TopBox is not responding")
    ...
    Public ReadOnly Property MaxStep() As Integer Implements IFocuserV3.MaxStep
        Get
            ...
            If maxStr = "Error" Then
                Throw New NotConnectedException("TopBox is not responding")
                maxStr = "0"
            End If
            Return Str(maxStr)
    ...
    Public Sub Move(Position As Integer) Implements IFocuserV3.Move
        ...
        Dim focPos As Integer = SerialCmd("P")
        If Not absoluteMode Then
            Position += focPos
        End If
        If Position < 1 Then Position = 1
        If backlashInfo <> "0" Then
            If backlashInfo.StartsWith("-") Then
                If Not lastDirection Then focPos -= Str(backlashInfo)
            Else
                If lastDirection Then focPos -= Str(backlashInfo)
            End If
        End If

        lastDirection = Position < focPos
        If SerialCmd("G" + Str(Position)) <> "G" Then Throw New NotConnectedException("TopBox is not responding")
    ...
    Public ReadOnly Property Position() As Integer Implements IFocuserV3.Position
        Get
            ...
            If posStr = "Error" Then Throw New NotConnectedException("TopBox is not responding")
            focuserPosition = Val(posStr)
...
#End Region
    ...
    Friend Sub ReadProfile()
        Using driverProfile As New Profile()
            ...
            backlashInfo = Convert.ToInt32(driverProfile.GetValue(driverID, backlashInfoProfileName, String.Empty, backlashInfoDefault))
        End Using
    End Sub
    ...
    Friend Sub WriteProfile()
        Using driverProfile As New Profile()
            ...
            driverProfile.WriteValue(driverID, backlashInfoProfileName, backlashInfo.ToString)
        End Using
